 ...
 * filled `primary` pill (also `big` radius), inactive is transparent with a
 ...
 * one-off per screen.
 */
export function SegmentedIconToggle<T extends string>({ value, options, onChange }: SegmentedIconToggleProps<T>) {
  return (
