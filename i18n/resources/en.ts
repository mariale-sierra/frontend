const en = {
  ...
  challengeProgress: {
    ...
    membersSearchEmpty: 'No members match your search.',
    membersLoadError: 'Could not load members.',
    inviteMembersA11y: 'Invite people',
    membersDoingLabel: 'doing {{challenge}}',
    ...
    joinRequestApproveA11y: 'Approve',
    joinRequestRejectA11y: 'Reject',
    closeChallengeA11y: 'Close challenge (admin)',
    closeChallengeTitle: 'Close this challenge?',
  ...
  search: {
    ...
    seeMoreChallenges: 'See more',
    seeLessChallenges: 'See less',
  },
  metrics: {
  ...
  challengeRoutineDay: {
    ...
    setsCountLabel_one: '{{count}} set',
    setsCountLabel_other: '{{count}} sets',
    openExerciseA11y: 'Open {{name}}',
    exerciseOpenFailed: 'Could not open this exercise.',
    notesLabel: 'Notes',
    nextInCycleLabel: 'Next in the cycle',
    afterThatLabel: 'After that',
    restDayTitle: 'Rest day',
  ...
  invites: {
    ...
    heroTitle: 'Bring your people in',
    heroSubtitle: 'Search for friends already on HAVIT and invite them to {{challenge}}.',
  ...
  profile: {
    ...
    banUserA11y: 'Ban this user (admin)',
  ...
  chats: {
    ...
    lastMessageFromYou: 'You: {{message}}',
  ...
  spaces: {
    ...
    namePlaceholder: 'e.g. Girls running club',
    ...
    visibilityPublicDescription: 'Anyone can find it and join instantly',
    ...
    createSubmitCta: 'Create space',
    nameRequiredError: 'Give your space a name',
    saveError: 'Could not save this space.',
    deleteError: 'Could not delete this space.',
    createError: 'Could not create this space.',
    joinCta: 'Join',
    ...
    leaveCta: 'Leave space',
    leaveConfirmTitle: 'Leave this space?',
    leaveConfirmMessage: "You'll need to join again to come back.",
    leaveError: 'Could not leave this space.',
    infoLoadError: 'Could not load this space.',
    optionsA11y: 'Space options',
    membersScreenTitle: 'Members',
    membersEmpty: 'No members yet.',
    membersLoadError: 'Could not load members.',
    joinRequestsTitle: 'Join requests',
  ...
  exerciseCatalog: {
    ...
    muscleBrowser: {
      title: 'Muscles',
      regionsSubtitle: 'Browse by region',
      muscleCount_one: '{{count}} muscle',
      muscleCount_other: '{{count}} muscles',
      primaryIn: 'Primary in',
      secondaryIn: 'Secondary in',
      emptyPrimary: 'No exercises use this muscle as primary yet.',
      emptySecondary: 'No exercises use this muscle as secondary yet.',
    },
    categories: {
      strength: 'Strength',
  ...
  about: {
    title: 'About & Credits',
    exerciseDataTitle: 'Exercise data',
    exerciseDataCredit: 'Exercise data by RepDB (repdb.co), used under license.',
